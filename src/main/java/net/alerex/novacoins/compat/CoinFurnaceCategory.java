...
public class CoinFurnaceCategory implements DisplayCategory<BasicDisplay> {
	public static final Identifier TEXTURE = new Identifier(NovaCoins.MOD_ID, "textures/gui/coin_furnace_gui.png");
	...
	public Renderer getIcon() {
		return EntryStacks.of(ModBlocks.COIN_FURNACE.asItem().getDefaultStack());
	}
